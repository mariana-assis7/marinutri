...
Agora vamos criar a autenticação do sistema. O sistema deve permitir que um nutricionista crie uma conta e faça login. Use o Neon Auth que já está configurado no projeto "Mari Nutri".
...
- Cores predominantes bordo e verde, com tons pasteis, remetendo à área da saúde e nutrição
- Logo com o texto "Mari Nutri" no topo de ambas as telas